...
Usage::
    ...
    PYTHONPATH=... python -m ipu_apps.kernels.softmax.softmax_rows.benchmark.benchmark
"""
...
from ipu_apps.kernels.softmax.softmax_rows import SoftmaxRowsApp, LANES, ROW_BYTES
