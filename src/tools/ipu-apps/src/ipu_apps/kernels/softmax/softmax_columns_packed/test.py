...
from ipu_apps.kernels.softmax.test_support import assemble_kernel, run_random_array
from ipu_apps.kernel_registry.cases import run_case
from ipu_apps.kernels.softmax.softmax_columns_packed.cases import CASES
