...
Usage::
    ...
    PYTHONPATH=... python -m ipu_apps.kernels.softmax --axis rows --n 300 --rows 8
    PYTHONPATH=... python -m ipu_apps.kernels.softmax --axis columns --width 100 --rows 64
    PYTHONPATH=... python -m ipu_apps.kernels.softmax --shape 32,300 --dim 1
    PYTHONPATH=... python -m ipu_apps.kernels.softmax --catalog
...
from ipu_apps.kernels.softmax.registry import catalog, lookup, lookup_torch
